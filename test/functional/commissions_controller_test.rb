...
class CommissionsControllerTest < ActionController::TestCase
  ...
  test "should create commission" do
    assert_difference('Commission.count') do
      post :create, commission: { artist: @commission.artist, colour: @commission.colour, email: @commission.email, name: @commission.name, style: @commission.style }
    end
  ...
  test "should update commission" do
    put :update, id: @commission, commission: { artist: @commission.artist, colour: @commission.colour, email: @commission.email, name: @commission.name, style: @commission.style }
    assert_redirected_to commission_path(assigns(:commission))
  end
